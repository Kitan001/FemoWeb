...
<head>
  ...
  <title>Estates Housing Category Bootstrap Responsive Web Template | Services :: W3Layouts </title>
    ...
    <div class="portfolio-main py-lg-5 py-md-4 py-2">
      <div class="container">
        ...
        <div class="text-center">
          <a href="#get" class="btn btn-style btn-primary mt-md-5 mt-4">See all works <span
